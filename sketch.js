...
function pauseUnpause(pause) {
    paused = pause;
    runPauseButton.label = paused ? "Empezar" : "Parar";
}
...
function setup() {
    ...
    runPauseButton = new Button("Empezar", 430, 20, 55, 30, runpause);
    uiElements.push(runPauseButton);
    uiElements.push(new Button("Paso por Paso", 430, 70, 95, 30, step));
    uiElements.push(new Button("Reiniciar", 430, 120, 55, 30, restart));
...
function draw() {
    ...
    text("Estado de busqueda - " + status, 10, 450);
